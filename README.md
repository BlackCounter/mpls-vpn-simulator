...
First of all , i must tell you i'm using https://www.eve-ng.net/index.php/download/ 
Eve-ng emulator.please install professional version on your ubuntu linux.
All of files must import to eve-ng.
